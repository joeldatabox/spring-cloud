package br.com.springmongoconfig.service.repository.impl;


import br.com.springexception.throwables.repository.SpringBootRepositoryIdIsNullException;
import br.com.springexception.throwables.repository.SpringBootRepositoryUserNotInformedException;
import br.com.springmodel.model.Model;
...
import static br.com.springmongoconfig.service.infra.Aggregate.createAggregations;
import static br.com.springmongoconfig.service.infra.Aggregate.createAggregationsCount;
import static org.springframework.data.mongodb.core.aggregation.Aggregation.match;
import static org.springframework.data.mongodb.core.aggregation.Aggregation.newAggregation;
import static org.springframework.data.mongodb.core.aggregation.Aggregation.project;
import static org.springframework.data.mongodb.core.query.Criteria.where;

public class CustomMongoRepositoryImpl<T extends Model<ID>, ID extends Serializable> extends SimpleMongoRepository<T, ID> implements br.com.springmongoconfig.service.repository.CustomMongoRepository<T, ID> {
    ...
    private final void validateId(final ID id) {
        if (id == null) {
            throw new SpringBootRepositoryIdIsNullException(this.CLASS);
        }
    }

    private final void validateUser(final User user) {
        if (user == null) {
            throw new SpringBootRepositoryUserNotInformedException(this.CLASS);
        }
    }
