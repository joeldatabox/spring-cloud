package br.com.springgateway.config;
 ...
 */
@Configuration
@EnableMongoRepositories(basePackages = "br.com.springbasicsecurity.infra.repository", repositoryBaseClass = CustomMongoRepositoryImpl.class)
