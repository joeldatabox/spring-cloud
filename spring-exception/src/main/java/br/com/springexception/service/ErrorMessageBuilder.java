...
public class ErrorMessageBuilder {
    ...
    public ErrorMessage build(final HttpMessageNotReadableException ex) {
        ...
        SpringBootException de = (SpringBootException) findInivistateException(ex, null);
    ...
    public ErrorMessage build(final SpringBootException ex) {
        this.message = new ErrorMessage();
    ...
    public ErrorMessage build(final SpringBootRepositoryException ex) {
        this.message = new ErrorMessage();
        setStatus(ex.getStatus());
        printException(ex);
        return this.message;
    ...
    public ErrorMessage build(final SpringBootSecurityUnauthorizedException ex) {
        this.message = new ErrorMessage();
        setStatus(ex.getStatus());
        setMessage(ex.getMessage());
        setObjectName(ex.getObjectName());
    ...
    private Throwable findInivistateException(final Throwable exActual, final Throwable exPrevius) {
        ...
        if (exActual instanceof SpringBootException) {
            return exActual;
        } else {
