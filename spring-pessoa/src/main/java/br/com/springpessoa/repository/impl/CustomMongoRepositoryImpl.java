package br.com.springpessoa.repository.impl;
...
public class CustomMongoRepositoryImpl<T extends Model<ID>, ID extends Serializable> extends SimpleMongoRepository<T, ID> implements br.com.springpessoa.repository.CustomMongoRepository<T, ID> {
